        ...
        <footer className="flexCenter pb-24 pt-20">
            <div className="max_padd_container flex w-full flex-col gap-14">
                <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row ">
                    <Link to='/' className="mb-10 bold-20">BodyPiel</Link>
                        ...
                        <div className="flex flex-col gap-5">
                            <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                                {FOOTER_CONTACT_INFO.links.map((link) => (
                                    <a href={link.url} key={link.label} className="flex gap-4 md:flex-col lg:flex-row">
                                        <p>{link.label}: </p>
                        ...
                        <div className="flex">
                            <FooterColumn title={SOCIALS.title}>
                                <ul className="flex gap-4">
                                    <li>
                                        <a href="https://www.facebook.com/profile.php?id=100091333732368" target="_blank" rel="noopener noreferrer">
                                            <img src={facebookIcon} alt="Facebook" width={22} height={22} />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/body_piel" target="_blank" rel="noopener noreferrer">
                ...
                <p className="text-center regular-14 text-gray-30">
                    2024 BodyPiel | Todos los derechos reservados.
                </p>
            </div>
        </footer>
    );
